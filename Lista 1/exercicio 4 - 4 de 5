...
int main() {
    ...
    //Solicitar número de times e validar
    do {
    ...
    int jogos[n][n][2];  //Armazenar os placares de cada jogo
    ...
    for (int i = 0; i < n; i++) {
        for (int j = 0; j < n; j++) {
            if (i != j) {
                ...
                //Verifica a maior diferença de gols
    ...
    //Identificar os times com mais vitórias, derrotas e empates
    ...
    if (max_empates == 0) {
        printf("Time(s) com mais empates: nao houve empates\n");
        printf("\n");
    } else {
